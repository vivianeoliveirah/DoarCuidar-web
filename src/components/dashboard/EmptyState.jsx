...
export default function EmptyState({
  ...
  return (
    <div className="flex min-h-56 flex-col items-center justify-center rounded-[1.35rem] border border-dashed border-slate-200 bg-white px-6 py-10 text-center shadow-[0_18px_45px_rgba(15,23,42,0.04)]">
