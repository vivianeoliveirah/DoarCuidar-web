    ...
    <span className="block text-xs text-slate-400 mt-2 text-center">
      2ª Surata Al Báçara – A Vaca 215
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center mt-6">
          <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-xl font-semibold shadow-md transition-all hover:scale-105">
            Explorar causas
          </button>

          <button className="border border-emerald-600 text-emerald-600 hover:bg-emerald-50 px-8 py-3 rounded-xl font-semibold transition-all">
            Cadastrar ONG
          </button>
        </div>
